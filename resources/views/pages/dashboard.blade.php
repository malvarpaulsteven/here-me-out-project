...
@section('content')
<section class="dashboard-page p-5 vh-sm-100 d-sm-flex justify-content-center align-items-center" id="portfolio">
    <div class="container">
      <div class="row row-wrap text-center g-4">
        <div class="col-md-3">
          <div class="card-css card mb-2">
